...
# Parameters:
# In this code we first compute our future waypoints and then calculate an optimal path 
# This optimal path is the path that we should take to reach the next waypoint.
